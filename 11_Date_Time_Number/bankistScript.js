  ...
  movs.forEach(function (mov, i) {
    ...
    const html = `
      ...
      i + 1
        ...
        <div class="movements__value">${formatAmount(mov, acc.locale, acc.currency)}</div>
      </div>
    `;
...
btnTransfer.addEventListener('click', function (e) {
  ...
  if (
    ...
    // add transfer date
    currentAccount.movementsDates.push((new Date()).toISOString().padStart(2, 0));
    receiverAcc.movementsDates.push((new Date()).toISOString().padStart(2, 0));
